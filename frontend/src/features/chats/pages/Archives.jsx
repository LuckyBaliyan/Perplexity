...
import { LayoutGrid, List, Archive, Search } from 'lucide-react';
...
/** Single folder-style card, grid or list variant */
...
/**
 * ArchivesView — renders archived chats as folder cards (grid or list).
 * Purely presentational; Dashboard owns navigation state.
 */
export function Archives({ chats, getChatTitle, onSelectChat }) {
            ...
            <div className="max-w-5xl mx-auto w-full py-8 px-1">
                  ...
                  <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
                        <div>
                              ...
                              <p className="text-xs text-[var(--text-muted)] mt-0.5">
                                    {chats.length} archived {chats.length === 1 ? 'chat' : 'chats'}
                              </p>
                        </div>
                  ...
                  {filtered.length === 0 ? (
                        <div className="flex flex-col items-center justify-center text-center py-20 gap-2">
                              ...
                              <p className="text-sm text-[var(--text-primary)] font-medium">No archived chats</p>
                              <p className="text-xs text-[var(--text-muted)]">Chats you archive will show up here.</p>
                        </div>
                  ) : viewMode === 'grid' ? (
